...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="document">
		<HEAD>
			...
			<LINK href="{@contextPath}/STYLE/links.css" rel="stylesheet" type="text/css"/>
						...
						<DIV class="indexNews">
							<TABLE class="download">
								<TR class="downloadtitle">
									...
									<TD width="428" align="center">網站名稱</TD>
									<TD width="137" align="center">聯絡電話</TD>
								</TR>
